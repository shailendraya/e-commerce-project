...
export const register = (username, email, password, avatar, role) => async (dispatch) => {
    try {
...
export const loadUser = () => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`http://localhost:8000/api/v1/user`, {withCredentials: true});
